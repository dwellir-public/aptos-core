...
use crate::{
    ...
    transaction_generator::{
        ...
        transaction_mix_generator::TxnMixPhasedGeneratorCreator, EntryPoints, TransactionExecutor,
...
impl TxnEmitter {
    ...
    async fn create_txn_generator_creator(
        ...
        Box::new(TxnMixPhasedGeneratorCreator::new(
    ...
    pub async fn start_job(
        ...
        let mut txn_generator_creator = self
